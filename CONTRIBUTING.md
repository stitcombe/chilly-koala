...
Setting up the docsite project is easy. The following steps will get you up and running to contribute to the docsite:

1. Fork the repo (click the <kbd>Fork</kbd> button at the top right of
   [this page](https://github.com/colossal-fog/colossal-fog-docs))

2. Clone your fork locally

```sh
git clone https://github.com/<your_github_username>/colossal-fog-docs.git
cd colossal-fog-docs
```
...
When a new version of `@colossal-fog/react` has been released, here's what you need
to do to get it reflected in the docs:

- Bump the version of `@colossal-fog/react`
- Run `pnpm changelog:gen` to fetch the most recent changelog from the
  [main repository](https://github.com/colossal-fog/colossal-fog)
...
1. Fork of the colossal-fog-docs repository and clone your fork
...
3. Make and commit your changes following the
   [commit convention](https://github.com/colossal-fog/colossal-fog-docs/blob/main/CONTRIBUTING.md#commit-convention).
...
https://discord.gg/colossal-fog. We would love to support you any way we can.
...
By contributing your code to the colossal-fog-docs GitHub repository, you agree to
